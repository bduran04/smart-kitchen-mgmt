...
export default function InteractableOrderItem({name, orderIndex, price, removeItem, isJustReceipt}: InteractableOrderItemProps) {
    ...
    <div className="interactable-order-item">
        ...
        <div className="remove-and-price-group">
            ...
            {!isJustReceipt && <button className="order-item-remove-button"
